		...
		<div class="main_page_catalog_inner container">
			...
			<section class="logos_section brands" id="brands">
				...
				?>"><img width="100" data-aos="fade-up" data-aos-delay="350"
						src="<?php echo get_template_directory_uri(); ?>/img/BMW11.svg" alt="Ax motors BMW" /></a>
				<a href="<?php
				$current_language = pll_current_language();
				if ($current_language == 'en') {
				...
				?>" style="padding-top:13px">
					<img width="100" data-aos="fade-up" data-aos-delay="550"
						src="<?php echo get_template_directory_uri(); ?>/img/Audi11.svg" alt="Ax motors Audi" /></a>
				...
				?>" style="padding-top:20px">
					<img width="80" data-aos="fade-up" data-aos-delay="550"
						src="<?php echo get_template_directory_uri(); ?>/img/Lotus11.svg" alt="Ax motors Lotus" /></a>
				...
				?>" style="padding-top:17px">
					<img width="100" data-aos="fade-up" data-aos-delay="550"
						src="<?php echo get_template_directory_uri(); ?>/img/Mini11.svg" alt="Ax motors Mini" /></a>
