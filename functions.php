...
function enqueue_custom_scripts()
{
    ...
    wp_enqueue_script('ax-car-main-script', get_template_directory_uri() . '/dist/js/script.js', array('jquery', 'google-recaptcha', 'select2-script', 'swiper-script', 'accordion-script'), 'defer', true);
