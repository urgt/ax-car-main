                ...
                <form action="<?php echo esc_url( $url_manager->getFormActionUrl() ); ?>" method="GET" class="wpc-filter-range-form <?php echo esc_attr( $hasSliderClass ); ?>" id="wpc-filter-range-form-<?php echo esc_attr($filter['ID']); ?>">
                    <div class="wpc-filters-range-wrapper">
                        <div class="wpc-filters-range-column wpc-filters-range-min-column">
                            ...
                            <span>Min</span><input type="number" class="wpc-filters-range-min" name="<?php echo esc_attr( $minName ); ?>" pattern="\d*" min="<?php echo  $absMin?>" max="<?php echo  $absMax?>" value="<?php echo esc_attr( $min ); ?>" step="<?php echo esc_attr( $filter['step'] ); ?>" data-min="<?php echo esc_attr( $absMin ); ?>" />
                        </div>
                        <div class="wpc-filters-range-column wpc-filters-range-max-column">
                            <span>Max</span><input type="number" class="wpc-filters-range-max" name="<?php echo esc_attr( $maxName ); ?>" pattern="\d*" min="<?php echo  $absMin?>" max="<?php echo  $absMax?>" value="<?php echo esc_attr( $max ); ?>" step="<?php echo esc_attr( $filter['step'] ); ?>" data-max="<?php echo esc_attr( $absMax ); ?>" />
                        </div>
                    </div>
                    <?php
                    /**
